...
While ($foldername -eq "components" -or $foldername -eq "signatures" -or $foldername -eq "models" -or $foldername -eq "libraries" -or $foldername -eq "export" -or $foldername -eq "fieldlayout" -or $foldername -eq "templates" -or $foldername -eq "fieldsyntax" -or $foldername -eq "fieldinterface" -or $foldername -eq "fieldtemplate" -or $foldername -eq "formats" -or $foldername -eq "global_constants" -or $foldername -eq "global_procs" -or $foldername -eq "global_vars" -or $foldername -eq "glyphs" -or $foldername -eq "helptexts" -or $foldername -eq "include_procs" -or $foldername -eq "menus" -or $foldername -eq "messages" -or $foldername -eq "panels"  -or $foldername -eq "entities"){
	# go up one parent 
...
##	}
	...
	"excel" {
		$executable 	= "D:\uniface\uniface9601\common\bin\idf.exe"
		$administration	= "D:\projects\uniface\excel"					
	}
	"excel2" {
		$executable 	= "D:\uniface\uniface9601\common\bin\idf.exe"
		$administration	= "D:\projects\uniface\excel2"
	}
	"excel3" {
		$executable 	= "D:\uniface\uniface9601\common\bin\idf.exe"
		$administration	= "D:\projects\uniface\excel3"
	}
	"excel4" {
		$executable 	= "D:\uniface\uniface9601\common\bin\idf.exe"
		$administration	= "D:\projects\uniface\excel4"					
	}
	"excel5" {
		$executable 	= "D:\uniface\uniface9401\common\bin\idf.exe"
		$administration	= "D:\projects\uniface\excel5"					
	}
	"uarchitect" {
		$executable 	= "D:\uniface\uniface9601\common\bin\idf.exe"
		$administration	= "D:\projects\uniface\$project_name"
	}
	"uarchitect1" {
		$executable 	= "D:\uniface\uniface9601\common\bin\idf.exe"
		$administration	= "D:\projects\uniface\$project_name"
